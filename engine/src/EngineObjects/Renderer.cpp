...
Shape2DLined::Shape2DLined(ShapeForm form, Color c, Color linec, float linel)
    : Shape2D(form, c), lineColor(linec), lineSize(linel) {};
...
TextShape::TextShape(ShapeForm form, Color c, string &txt, int fSize,
                     Color tColor)
    : Shape2D(form, c), text(txt), fontSize(fSize), color(tColor) {};
